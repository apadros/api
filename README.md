...
The project aims to provide support for simple, generic functionality such as file I/O, memory manipulation, string operations and others which can be used regardless of the type of application.
